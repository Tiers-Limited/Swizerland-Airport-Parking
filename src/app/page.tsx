          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-stretch">
            <div className="bg-gray-200 rounded-sm p-8 md:p-10">
              <h3 className="text-3xl font-bold text-gray-900 mb-4">
                Why become a parking partner?
              </h3>
              <p className="text-gray-700 leading-relaxed mb-8">
                Reach more customers through our marketplace and manage your
                listings with one host portal. Register as a host, and your
                account will stay under admin approval until verified. Once
                approved, you will get full access to the host portal.
              </p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              {[
                ...
                <div
                  key={item}
                  className="bg-white rounded-sm p-5 border border-gray-200 flex gap-3"
                >
                  <span className="text-primary-500 text-xl leading-none">
                    ✦
                  </span>
