            ...
            <div>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <p className="font-medium text-gray-900">{formatDate(booking.start_datetime)}</p>
                  <p className="text-sm text-gray-600">Ankunft um {arrivalTime}</p>
                </div>
                <div>
                  <p className="text-sm text-gray-500">Check-out</p>
                  <p className="font-medium text-gray-900">{formatDate(booking.end_datetime)}</p>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          ...
          <Button onClick={() => globalThis.print()}>
            <svg className="h-5 w-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M17 17h2a2 2 0 002-2v-4a2 2 0 00-2-2H5a2 2 0 00-2 2v4a2 2 0 002 2h2m2 4h6a2 2 0 002-2v-4a2 2 0 00-2-2H9a2 2 0 00-2 2v4h6a2 2 0 002 2zm8-12V5a2 2 0 00-2-2H9a2 2 0 00-2 2v4h10z" />
            </svg>
            Buchung drucken
          </Button>
          <Link href="/">
